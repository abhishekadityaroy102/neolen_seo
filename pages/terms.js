...
function terms(){
 return (
  <div>
   ...
   <h1 className='text-white font-extrabold opacity-50 text-[2.3em] textShadow absolute top-[1.8em] lg:left-[1.3em] place-self-center scroll-smooth'>Terms and Conditions</h1>
             <h1 className='text-white font-extrabold opacity-50 text-[2.3em] textShadow absolute bottom-[1.8em] lg:right-[1.3em] place-self-center'>Terms and Conditions</h1>  
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Neolen, KESHAV
              MARKET, RAJARAM KI BAGIYA, SHAMSHABAD ROAD, AGRA. Agra UP 282001
              IN.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Neolen, accessible from{' '}
              <a
                href='https://www.neolen.com/'
                rel='noreferrer'
                style={{ color: 'blue' }}
                target='_blank'
              >
                https://www.neolen.com/
              </a>
            </p>
          </li>
          <li>
   ...
   <h1 className='text-white font-extrabold opacity-50 text-[2.3em] textShadow absolute top-[1.8em] lg:left-[1.3em] place-self-center scroll-smooth'>Terms and Conditions</h1>
             <h1 className='text-white font-extrabold opacity-50 text-[2.3em] textShadow absolute bottom-[1.8em] lg:right-[1.3em] place-self-center'>Terms and Conditions</h1>  
             <div className='w-4/5 pl-8 pb-80 mb-100'>
             <p>
        ...
        <ul>
          <li>
            ...
            <a
              href='https://www.neolen.com/contact-us'
              target='_blank'
              rel='noreferrer'
              style={{ color: 'blue' }}
            >
              https://www.neolen.com/contact-us
            </a>
          </li>
          <li>Phone Number : <a href='tel:00917678511552' type='tel'>0091-767-851-1552</a></li>
          <li>Email : <a href="mailto:support@neolen.com" type='email'>support@neolen.com</a></li>
          <address>Address: "KESHAV MARKET, RAJARAM KI BAGIYA, SHAMSHABAD ROAD",<br></br>Locality: "Agra, Uttar Pradesh",<br></br>Postal Code: "282001",<br></br>Country: "IN"</address>
        </ul>
              </div>
              </div>
