...
function privacyPolicy(){
 return (
  ...
  <h1 className='text-white font-extrabold opacity-50 text-[2.3em] textShadow absolute top-[1.8em] lg:left-[1.3em] place-self-center scroll-smooth'>Privacy Policy</h1>
            <h1 className='text-white font-extrabold opacity-50 text-[2.3em] textShadow absolute bottom-[1.8em] lg:right-[1.3em] place-self-center'>Privacy Policy</h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Neolen, KESHAV MARKET, RAJARAM KI
              BAGIYA, SHAMSHABAD ROAD, AGRA. Agra UP 282001 IN..
            </p>
          </li>
          <li>
            <p>
