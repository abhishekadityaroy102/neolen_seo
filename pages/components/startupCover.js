...
import CoverStartup2 from '/public/startupCover2.webp'
import Youtube from '/public/youtube.webp'



export default function StartupCover() {
  return (
        <div id='home' className='background-main background-cover grid place-content-center'>
            <Nav></Nav>
            <div className='absolute lg:left-[10.7em] lg:top-[28%] top-[16%] text-center lg:text-left lg:block grid place-content-center place-self-center'>
                <h1 className='font-extrabold lg:text-[3.7em] text-[3em] leading-tight text-blue place-self-center'>Indian Startup<br></br>Support</h1>
                <p className='lg:w-[28em] w-[25em] leading-[1.8em] mt-[1.7em] text-blue font-normal lg:text-sm text-sm lg:place-self-start place-self-center'>Our mission is to help creative and innovating startups to make world a better place and achieve a comprehensive stand in the global market.</p>
            ...
            <div className=' place-self-center absolute lg:w-[33em] w-[20em] lg:h-[32em] h-[auto] lg:top-[7em] lg:right-[7em] bottom-[5em] grid place-content-center'>
                ...
                <Image src={CoverStartup2} alt="img"></Image>
